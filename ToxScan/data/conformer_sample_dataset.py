...
class ConformerSampleDataset(BaseWrapperDataset):
    def __init__(self, dataset, seed, atoms, coordinates, atom_feature, bond_feature):
    ...
    def __cached_item__(self, index: int, epoch: int):
        ...
        atom_feature = self.dataset[index][self.atom_feature]
        bond_feature = self.dataset[index][self.bond_feature]
